...
7. Вывести id, имя, email и дату создания пользователей
   select id, name, email, date from students;
...
15. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть слово Andrey
    select * from students 
    where date = '2021-07-12 00:00:00' and name like '%Andrey%';
...
27. Вывести пользователей где date равен 2020-10-03 00:00:00, 2021-05-19 00:00:00, 2021-03-26 00:00:00
    select * from students
    where date='2020-10-03 00:00:00' or date='2021-05-19 00:00:00' or date='2021-03-26 00:00:00';
...
31. Вывести id пользователя, имя, дату создания пользователя. Отсортировать по порядку возрастания даты добавления пользоватлеля.
  select id,name,date from students
  order by date;
